...
def process(letter,iA,iB,iC,nA,nB,nC,A1,A2,B1,B2,C1,C2,ref1,ref2,stator):
    ...
    letter = C[statorIndex]



#i just clocked instead of making it linear substitutions
#(which works, but its weird because, you just have to get one index and thats it, not how the enigma worked)
...
staticRotor,discardThisValue = rotorgen(initCharset)

a1,a2 = rotorgen(mason)
b1,b2 = rotorgen(mason)
c1,c2 = rotorgen(mason)
r1,r2 = reflectorgen(mason)
