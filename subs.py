...
def encryptext():
    codec(fetchdata("chars"), fetchdata("key"), input("Enter a message to encrypt: "))

def decryptext():
    codec(fetchdata("key"),fetchdata("chars"), input("Enter a message to decrypt: "))
...
def codec(charset1,charset2,text1):#the charset1 is the pair that matches with the type of writing text1 is (if text1 is encrypted then charset1 is the key.txt file)
    text2 = ""
